...
module.exports = function v2m() {
    ...
    function getComponentByNode(e) {
        try {
            ...
            return  (internalInstance && internalInstance.return && internalInstance.return.pendingProps && internalInstance.return.pendingProps.children && internalInstance.return.pendingProps.children.length > 0) ? internalInstance.return.pendingProps.children[0]._self.stateNode : internalInstance.return.pendingProps.children._self.stateNode;
        } catch(err) {
            return null;
        }
    }
